...
file_to_load = os.path.join("..", "Challenges", "election_results.csv")
# Add a variable to save the file to a path.
file_to_save = os.path.join("..", "Challenges", "election_results.txt")
...
#         county_results = (f'{county_name}: {wc_percentage:.1f}% ({c_votes})\n')
